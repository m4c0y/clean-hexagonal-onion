...
import com.fabriciooliveira.clean_hexagonal_onion.data.book.BookJPA;
import com.fabriciooliveira.clean_hexagonal_onion.data.book.BookRepository;
...
class AuthorActionCommandsIntegrationTest {
    ...
    void writeBook() throws Exception {
        ...
        var writeBookDTOJson = objectMapper.writeValueAsString(new RegisterBookDTO("title", "CRIME"));
